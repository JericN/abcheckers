...
export default function Landing() {
  ...
  return (
    <section className="flex flex-col items-center min-h-screen py-24 lg:py-52 select-none">
      <div
        className={`${style_width_a} flex flex-col lg:flex-row gap-5 px-10 w-screen`}
      >
        {/* ICON */}
        <motion.img
        ...
        <div className="flex flex-col justify-center gap-5 lg:-mt-10">
          ...
          >
            ...
            <motion.span>
              . Our aim is to use data analysis techniques to look into{" "}
            </motion.span>
            <motion.span>
              relevant Twitter data and provide context to the current state of
              the{" "}
            </motion.span>
