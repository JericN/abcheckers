            ...
            <div className={`${style_width_a} flex flex-col lg:flex-row gap-5 px-10 w-screen`}>
                ...
                <div className='flex flex-col justify-center gap-5 lg:-mt-10'>
                    ...
                    >
                        ...
                        <motion.span custom={0} variants={highlightVariant}> Misinformation</motion.span>
                        <motion.span> Regarding the </motion.span>
                        <motion.span custom={1} variants={highlightVariant}>Country's Inflation</motion.span>
                        <motion.span> and </motion.span>
                        <motion.span custom={2} variants={highlightVariant}>Weakening Peso</motion.span>
                        ...
                        <motion.span custom={3} variants={highlightVariant}>Philippines.</motion.span>
                    </motion.div>
